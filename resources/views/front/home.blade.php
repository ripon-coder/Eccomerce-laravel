            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="banner banner-display">
                        <a href="#">
                            <img data-src="{{asset('assets/images/slider/slide-1.jpg')}}" class="lazyload" alt="Banner">
                        </a>
                    ...
                    <div class="intro-banners">
                        <div class="row row-sm">
                            <div class="col-md-6 col-lg-12">
                                <div class="banner banner-display">
                                    <a href="#">
                                        <img data-src="{{asset('assets/images/banners/home/intro/banner-1.jpg')}}" class="lazyload" alt="Banner">
                                    </a>
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="banner banner-display mb-0">
                                    <a href="#">
                                        <img data-src="{{asset('assets/images/banners/home/intro/banner-2.jpg')}}" class="lazyload" alt="Banner">
                                    </a>
                    ...
                    <div class="row">
                        <div class="col-6 col-sm-4 col-lg-2">
                            <a href="#" class="cat-block">
                                <figure>
                                    <span>
                                        <img data-src="{{asset('assets/images/demos/demo-4/cats/1.png')}}" class="lazyload" alt="Category image">
                                    </span>
                                </figure>
                        ...
                        <div class="col-6 col-sm-4 col-lg-2">
                            <a href="#" class="cat-block">
                                <figure>
                                    <span>
                                        <img data-src="{{asset('assets/images/demos/demo-4/cats/2.png')}}" class="lazyload" alt="Category image">
                                    </span>
                                </figure>
                        ...
                        <div class="col-6 col-sm-4 col-lg-2">
                            <a href="#" class="cat-block">
                                <figure>
                                    <span>
                                        <img data-src="{{asset('assets/images/demos/demo-4/cats/3.png')}}" class="lazyload" alt="Category image">
                                    </span>
                                </figure>
                        ...
                        <div class="col-6 col-sm-4 col-lg-2">
                            <a href="#" class="cat-block">
                                <figure>
                                    <span>
                                        <img data-src="{{asset('assets/images/demos/demo-4/cats/4.png')}}" class="lazyload" alt="Category image">
                                    </span>
                                </figure>
                        ...
                        <div class="col-6 col-sm-4 col-lg-2">
                            <a href="#" class="cat-block">
                                <figure>
                                    <span>
                                        <img data-src="{{asset('assets/images/demos/demo-4/cats/5.png')}}" class="lazyload" alt="Category image">
                                    </span>
                                </figure>
                        ...
                        <div class="col-6 col-sm-4 col-lg-2">
                            <a href="#" class="cat-block">
                                <figure>
                                    <span>
                                        <img data-src="{{asset('assets/images/demos/demo-4/cats/6.png')}}"  class="lazyload" alt="Category image">
                                    </span>
                                </figure>
